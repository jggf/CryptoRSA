...
public class DukptTests {
    ...
    public void testDecryptValidData() throws Exception {
        // Setup
        String bdkHexString = "00112233445566778899AABBCCDDEEFF"; // ANSI Test Key
        String ksnHexString = "0102012345678AE00002";
    ...
    public void testToDataKey() throws Exception {
        // Setup
        String bdkHexString = "00112233445566778899AABBCCDDEEFF"; // ANSI Test Key
        String ksnHexString = "0102012345678AE00065";
        ...
        byte[] dataKey = Dukpt.toDataKey(derivedKey);
